...
<body>
  <div class="container">
    <form class="form-container">
      <h3 class="textJudul mb-2">Daftar</h3>
      <div class="mb-3">
        ...
        <label for="exampleInputPassword1" class="form-label textForm">Konfirmasi Password</label>
        <div class="input-group mb-3">
          <span class="input-group-text" id="basic-addon1"><i class="fa-solid fa-unlock-keyhole"></i></span>
          <input type="password" class="form-control" id="exampleInputPassword1" placeholder="Masukan Password">
        </div>
      ...
      <div class="mt-1">
        <span class="textForm">Sudah Punya Akun? <a href="login.php" class="textForm text-hover">Masuk</a></span>
      </div>
    </form>
  </div>
